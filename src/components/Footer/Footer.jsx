...
const Footer = () => {
  const patLogoSrc = process.env.PUBLIC_URL + "/Banners/patlogo.png";
    ...
    <footer className="background text-white p-6">
      <div className="container mx-auto flex flex-wrap">
        ...
        <div className="w-full md:w-1/3 text-center mb-4 md:mb-0">
          <h1 className="text-3xl font-semibold mb-2">Patagonia s place</h1>
          <br />

          <h3 className="mb-1 text-xl">
            7500 Nw 25 St., Fl33122, Miami., FI 3300
          </h3>
          <br />
          ...
          <br />
          <h1 className="text-xl font-bold mb-2">Phone: 305 779 5688 </h1>
          <br />
          <h1 className="text-xl font-bold mb-2">Info@patagoniadistribution.com</h1>
        </div>
