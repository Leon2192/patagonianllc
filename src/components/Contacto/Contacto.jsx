...
const Info = () => {
  ...
  return (
    <div
      className="flex flex-col md:flex-row w-full info-container background"
      id="PrivateLabel"
    >
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:mr-2">
        <img
          src="/Banners/plot.png"
          alt="Placeholder"
          width={500}
          height={500}
      ...
      <div className="w-full md:w-1/2 flex flex-col md:mr-2 flex-grow">
        <div className="ml-6 mb-6 md:p-10">
          ...
          <p className="text-xl text-white font-bold m-1 text-center">
            Patagonia's Foods has developed a singular line of products that will
            enhance your menu.
          </p>
          <br />
        ...
        <motion.div
          ...
          ref={ref}
        >
          <div className="w-full md:max-w-md p-6  rounded-lg">
            <form>
